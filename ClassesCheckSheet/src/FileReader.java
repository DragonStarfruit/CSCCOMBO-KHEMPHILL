	...
	public Course readFromFile() {
		if(input.hasNextLine()) {
			...
			if (tokens[0].equals("RealTimeRemoteCourse")) {
				Course course = new RealTimeRemoteCourse (tokens[1],
						Integer.parseInt(tokens[2]),
						Integer.parseInt(tokens[3]),
						Integer.parseInt(tokens[4]),
						tokens[5]);
			...
			if (tokens[0].equals("InPersonCourse")) {
				Course course = new InPersonCourse (tokens[1],
						Integer.parseInt(tokens[2]),
						Integer.parseInt(tokens[3]),
						Integer.parseInt(tokens[4]),
						tokens[5]);
			...
			if (tokens[0].equals("FullRemteCourse")) {
				Course course = new FullRemoteCourse (tokens[1],
						Integer.parseInt(tokens[2]),
						Integer.parseInt(tokens[3]),
						Integer.parseInt(tokens[4]),
						tokens[5]);
